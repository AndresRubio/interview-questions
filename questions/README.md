...
35 questions across seven topics. Each answer sits behind a collapsible block — answer out loud first, then expand.

| File | Questions | Focus |
|---|---|---|
| [agent-protocols.md](agent-protocols.md) | 9 | MCP `2026-07-28`, A2A, ACP, `SKILL.md`. Mostly `verified 3-0`. |
